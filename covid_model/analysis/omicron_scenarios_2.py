...
if __name__ == '__main__':
    ...
    for scen_label, scen_params in scenarios.items():
        ...
        # model.set_param('ef', 0.905, trange=range(709, 709+7))
        # model.rebuild_ode_with_new_tc()
        # model.solve_seir()
        # plot(model, ax=axs['Hospitalized with Covid-19 (with two-week NPI)'], compartments=['Ih'], label=scen_label, max_value=4000)
